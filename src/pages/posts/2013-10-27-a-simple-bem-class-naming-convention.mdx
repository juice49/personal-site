export const meta = {
  ...
  description: 'BEM is a useful convention for structuring CSS, but can we make it less verbose?',
  date: '2013-10-27',
...
<nav class='main-nav'>
  <a class='main-nav__item' href='#'>Link</a>
    ...
    <a class='main-nav__item main-nav__item--featured main-nav__item--xmas' href='#'>Link</a>
</nav>
```
