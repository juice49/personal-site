...
<small>
  <sup>1.</sup> I say for now as there is some debate about Atom following the
  convention of the OS it is operating under (OS X, Unix and Windows all have
  their own locations for storing app configuration). Even if this does change,
  it should still be possible to symlink to a Dropbox-stored directory.
</small>
